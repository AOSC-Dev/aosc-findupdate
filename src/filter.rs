...
fn test_version_type() {
    ...
    assert_eq!(
        version_type(version_str_with_letter_notation),
        VersioningType::LetterNotation
    );
    assert_eq!(
        version_type(version_str_with_dashes),
        VersioningType::Dashes
    );
    ...
    assert_eq!(
        version_type(version_str_with_alpha),
        VersioningType::ReleaseTypes
    );
    assert_eq!(
        version_type(version_str_with_rc),
        VersioningType::ReleaseTypes
    );
    assert_eq!(
        version_type(version_str_with_rc_and_dash),
        VersioningType::ReleaseTypes
    );
    assert_eq!(
        version_type(version_str_with_shortned_alpha),
        VersioningType::ReleaseTypes
    );
    assert_eq!(
        version_type(version_str_with_shortned_beta),
        VersioningType::ReleaseTypes
    );
}
